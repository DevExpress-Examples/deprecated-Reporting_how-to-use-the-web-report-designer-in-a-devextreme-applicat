...
namespace BackendMvcProject.Controllers {
    public class ReportDesignerController : ReportDesignerApiController {
        ...
        public override ActionResult GetLocalization() {
            var result = base.GetLocalization();
            Response.AppendHeader("Access-Control-Allow-Origin", "*");
            return result;
        }
        ...
        public ActionResult GetReportDesignerModel(string reportUrl) {
            ...
            string modelJsonScript = 
                ...
                .GetJsonModelScript(
                    GetReport(reportUrl),      // Obtain a report to open in the Report Designer on application start.
        ...
        XtraReport GetReport(string reportUrl) {
        ...
        Dictionary<string, object> GetAvailableDataSources() {
            ...
            CustomSqlQuery query = new CustomSqlQuery() { Name = "Products", Sql = "SELECT * FROM Products" };
